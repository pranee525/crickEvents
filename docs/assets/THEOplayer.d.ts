...
/**
 * An ABR configuration object for managing the quality switching behaviour of the player.
 * Currently the player performs periodic 'probes' of higher playback qualities, for which
 * the intervals can be configured here.
 * @remarks
 * <br/> - Note: This API is in an experimental stage and may be subject to breaking changes.
 * <br/> - Only available with the feature `'hesp'`.
 ...
 * @public
 */
export declare interface HespAbrConfiguration {
    /**
     * The minimum amount of time between consecutive quality switches.
     */
    readonly minimumQualitySwitchInterval: number;
    /**
     * The short interval for performing higher-quality probes.
     * This is the default interval at which the player will perform ABR probes.
     */
    readonly probeShortInterval: number;
    /**
     * The long interval for performing higher-quality probes.
     * This is the interval for ABR probes the player will temporarily fall back
     * to after a downward quality switch has occurred.
     */
    readonly probeLongInterval: number;
}
...
export declare interface HespApi extends EventDispatcher<HespApiEventMap> {
    ...
    goLive(): Promise<void>;
    /**
     * True if the playback is in live mode.
     */
     ...
     */
    readonly metrics: HespMetricsApi;
}
...
export declare interface MeasurableNetworkEstimator extends NetworkEstimator {
     ...
     */
    createMeasurer(request: Request_2): RequestMeasurer;
}
...
export declare interface NetworkEstimatorController {
    /**
     * Returns the active `MeasurableNetworkEstimator`.
     * An internal implementation is provided by default, but externally it can only be used as a `NetworkEstimator`.
     * An external `MeasurableNetworkEstimator` implementation can be set for internal use by the player.
     */
    estimator: MeasurableNetworkEstimator;
}
...
export declare interface PlayerEventMap {
     ...
     */
    sourcechange: Event_2<'sourcechange'>;
    /**
     ...
     */
    currentsourcechange: Event_2<'currentsourcechange'>;
    /**
     ...
     */
    loadedmetadata: Event_2<'loadedmetadata'>;
    /**
     ...
     * <br/> - See {@link https://html.spec.whatwg.org/multipage/media.html#mediaevents:dom-media-readystate | HTML media - network state events}.
     */
    canplaythrough: Event_2<'canplaythrough'>;
    /**
     ...
     */
    durationchange: Event_2<'durationchange'>;
    /**
     * Fired when {@link ChromelessPlayer.volume} changes.
     */
    volumechange: Event_2<'volumechange'>;
    /**
     * Fired when the current representation changes.
     */
    representationchange: Event_2<'representationchange'>;
    /**
     * Fired when {@link ChromelessPlayer.playbackRate} changes.
     */
    ratechange: Event_2<'ratechange'>;
    /**
     ...
     */
    dimensionchange: Event_2<'dimensionchange'>;
    /**
 ...
 * @public
 */
export declare type RequestBody = ArrayBuffer | ArrayBufferView | Blob | string | null;
 ...
 * @public
 */
export declare type RequestType = 'manifest' | 'stream' | 'keyframe';
 ...
 * @public
 */
declare type RequestType_2 = '' | 'manifest' | 'segment' | 'content-protection';
 ...
 * @public
 */
export declare type ResponseBody = ArrayBuffer | Blob | Document | object | string | null;
 ...
 * @public
 */
declare type ResponseType_2 = 'arraybuffer' | 'blob' | 'document' | 'json' | 'stream' | 'text';
...
export declare interface TypedSource extends BaseSource {
     ...
     * <br/> - `'application/vnd.theoplayer.hesp+json'`: The media resource is an HESP stream.
     *
     * @remarks
     * <br/> - Available since v2.4.0.
     */
